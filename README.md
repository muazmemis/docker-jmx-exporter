[![Build status](https://travis-ci.com/muazmemis/docker-jmx-prometheus-exporter.svg?branch=master)](https://travis-ci.com/muazmemis/docker-jmx-prometheus-exporter) [![Docker Pulls](https://img.shields.io/docker/pulls/muazmemis/jmx-exporter.svg)](https://hub.docker.com/r/muazmemis/jmx-exporter)
...
Available on [Docker hub](https://hub.docker.com/r/muazmemis/jmx-exporter/)

## Building docker image

```sh
docker build -t muazmemis/jmx-exporter .
docker push muazmemis/jmx-exporter
```

## Running

```sh
docker run --rm -p "5556:5556" muazmemis/jmx-exporter
```
...
```sh
docker run --rm -p "5556:5556" -v "$PWD/config.yml:/opt/jmx_exporter/config.yml" muazmemis/jmx-exporter
```
